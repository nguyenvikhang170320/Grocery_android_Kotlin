...
import com.example.phinh.grocery.Shopping.FilterOrderShop;

import com.example.phinh.grocery.R;
import com.example.phinh.grocery.Shopping.activities.OrderDetailsSellerActivity;
import com.example.phinh.grocery.Shopping.models.ModelOrderShop;
...
public class AdapterOrderShop extends RecyclerView.Adapter<AdapterOrderShop.HolderOrderShop> implements Filterable {
    ...
    static class  HolderOrderShop extends RecyclerView.ViewHolder{
        ...
        private final TextView orderIdTv, orderDateTv, emailTv, amountTv, statusTv;
